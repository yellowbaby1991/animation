...
#### 思路：
 ...
 1. 继承View类重写onMeasure，onLayout，onDraw方法
 2. 在onMeasure方法中实现测量，重点处理宽和高都是wap_content时候的宽高
 3. 在onLayout方法中计算布局数据，如测量后的宽度，柱状图的间距等
 4. 在onDraw方法中
    - 使用Canvas.drawRect画柱形图
    - 使用Canvas.drawText写字
    - 使用Canvas.drawLine画线
 ...
 ##### PercentageBar.java
``` java
package yellow.com.percentagebar;
...
<LinearLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <TextView
        ...
        android:text="国内互联网公司融资额前20强(2012年至2015年6月)"
        android:textSize="20sp" />

    <yellow.com.percentagebar.PercentageBar
...
![enter description here][1]
  ...
  [1]: ./images/%E8%87%AA%E5%AE%9A%E4%B9%89%E6%9F%B1%E7%8A%B6%E5%9B%BE.gif "自定义柱状图.gif"